...
echo "开始打包$appDir/$projectName.app"
echo "开始打包$appDir/$ipaName.ipa"
...
curl -X PUT --data "changelog=$changelog" http://fir.im/api/v2/app/589d41f2959d6976980004c2?token=70c4abb7ff80ff18ba88117ac6aee5e1
#echo "\n打包上传更新成功！"
rm -rf $buildAppToDir
